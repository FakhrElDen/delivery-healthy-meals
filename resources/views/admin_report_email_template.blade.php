                             ...
                             <table role="presentation" cellpadding="0" cellspacing="0"  class="tbl-email">
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <h3 class="p-style">whith mobile phone <Span class="name-n-email">
                                           {{$data['mobile']}}
                                         </span></h3>
                                             </td>
                                     ...
                                     <tr>
                                         <td>
                                         <h3 class="p-style">bought plan name <Span class="name-n-email">
                                          {{$data['meal_name']}}
                                          </span></h3>
                                         </td>
                                     </tr>
                                     <tr>
                                        <td>
                                        <h3 class="p-style">Upload an excel sheet to him according to his plan to choose his meals.</h3>
